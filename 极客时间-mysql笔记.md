...
![image-20220410122144755](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20220410122144755.png)
...
<img src="C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20220410124227862.png" alt="image-20220410124227862" style="zoom:67%;" /><img src="C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20220410124029046.png" alt="image-20220410124029046" style="zoom: 67%;" />

 											图3 无索引下推执行流程																									图4 索引下推执行流程
...
3. 例子：
   ...
   <img src="C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20220411122149289.png" alt="image-20220411122149289" style="zoom:80%;" />
...
4. 如何安全地给小表加字段？
   ...
   3. 如果你要变更的表是一个热点表，虽然数据量不大，但是上面的请求很频繁，这时候kill可能未必管用，比较理想的机制是，在alter table语句里面 设定等待时间，如果在这个指定的等待时间里面能够拿到MDL写锁最好，拿不到也不要阻塞后 面的业务语句，先放弃。之后开发人员或者DBA再通过重试命令重复这个过程。![image-20220411122711929](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20220411122711929.png)
...
<img src="C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20220412103821653.png" alt="image-20220412103821653" style="zoom:50%;" />
